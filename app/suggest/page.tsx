              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-xs text-zinc-400 font-mono">
                    Selected: Lat {cafeFormData.lat.toFixed(4)}, Lng {cafeFormData.lng.toFixed(4)}
                  </span>
                </div>

                <div className="w-full rounded-xl overflow-hidden border border-zinc-800 relative bg-zinc-950">
                  <MapPicker
                    position={{ lat: cafeFormData.lat, lng: cafeFormData.lng }}
